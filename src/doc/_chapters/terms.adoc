...
| Il doit rester au moins une nuité dans le territoire de l'attaquant.
...
| Unités étant données à un joueur au début de sont tour, qu'il peut placer à sa guise sur ses territoires.
